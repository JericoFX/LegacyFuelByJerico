...
Config.Strings = {
	ExitVehicle = "Debes salir del vehiculo para repostar",
	EToRefuel = "Pulsa ~g~E ~w~para poner gasolina",
	JerryCanEmpty = "El bidon de gasolina esta vacio",
	FullTank = "Deposito lleno",
	PurchaseJerryCan = "Pulsa ~g~E ~w~para comprar un bidon de gasolina por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Pulsa ~g~E ~w~ para cancelar el repostaje",
	CancelFuelingJerryCan = "Pulsa ~g~E ~w~ para cancelar el repostaje",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Pulsa ~g~E ~w~ para usar el bidon",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Pulsa ~g~E ~w~para coger el bidon de gasolina"
	Config.Strings.RefillJerryCan = "Pulsa ~g~E ~w~ para rellenar el bidon"
end
